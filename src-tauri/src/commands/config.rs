...
fn get_preset_skills() -> Vec<SkillDefinition> {
    vec![
        ...
        // ---- 自我改进 (self-improving) ----
        SkillDefinition {
            id: "self-improving".into(),
            name: "Self-Improving Agent".into(),
            description: "自我反思 + 自我批评 + 自我学习 + 自组织记忆。Agent 在完成工作后自动评估和改进自身表现，持续积累经验。".into(),
            icon: "🧠".into(),
            source: "community".into(),
            version: None,
            author: Some("Community".into()),
            package_name: None,
            clawhub_slug: Some("self-improving".into()),
            installed: false,
            enabled: false,
            config_fields: vec![
                SkillConfigField {
                    key: "memoryPath".into(), label: "记忆存储路径".into(), field_type: "text".into(),
                    placeholder: Some("~/self-improving/".into()), options: None, required: false,
                    default_value: Some("~/self-improving/".into()),
                    help_text: Some("自我改进记忆的存储目录，包含 memory.md、corrections.md 等".into()),
                },
            ],
            config_values: HashMap::new(),
            docs_url: Some("https://clawic.com/skills/self-improving".into()),
            category: Some("自我改进".into()),
        },
        SkillDefinition {
            id: "self-improvement".into(),
            name: "Self-Improvement".into(),
            description: "捕获错误、纠正和知识缺口，实现持续改进。适用于命令失败、用户纠正、API 故障等场景，自动记录到 .learnings/ 目录。".into(),
            icon: "📚".into(),
            source: "community".into(),
            version: None,
            author: Some("Community".into()),
            package_name: None,
            clawhub_slug: Some("self-improving-agent".into()),
            installed: false,
            enabled: false,
            config_fields: vec![],
            config_values: HashMap::new(),
        ...
        SkillDefinition {
            id: "proactive-agent".into(),
            name: "Proactive Agent".into(),
            description: "将 AI Agent 从被动执行者转变为主动伙伴，预测需求并持续改进。支持 WAL 协议、工作缓冲区、自主 Cron 和实战模式。".into(),
            icon: "🚀".into(),
            source: "community".into(),
            version: None,
            author: Some("Community".into()),
            package_name: None,
            clawhub_slug: Some("proactive-agent".into()),
            installed: false,
            enabled: false,
            config_fields: vec![],
            config_values: HashMap::new(),
